...
from pyquantus.gui.seg_loading.advancedRoi import AdvancedRoiDrawGUI
from pyquantus.gui.seg_loading.qt_utils import MouseTracker, q_im_to_pil
...
class SegSelectionGUI(QDialog, Ui_constructRoi):
    def __init__(self, image_data: UltrasoundRfImage):
        ...
        super().__init__()
        self.setupUi(self)
        # loadUi(str(Path("pyquantus/gui/seg_loading/voi_selection.ui")), self)
