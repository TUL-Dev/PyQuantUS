...
class UtcAnalysis:
    ...
    Attributes:
        ...
        attenuationCoef (float): Attenuation coefficient of the entire ROI at the center frequency (dB/cm).
        ...
        refAttenuation (float): Total attenuation coefficient of the reference phantom at the center frequency (dB/cm).
    ...
    def computeUtcWindows(self, extraParams=True) -> int:
        ...
        if extraParams:
            ...
            self.backScatterCoef = self.computeBackscatterCoefficient(imgWindow, refWindow, roiDepth=minTop)
    ...
    def computeAttenuationCoef(self, rfData: np.ndarray, refRfData: np.ndarray,
        ...
        Returns:
            float: Local attenuation coefficient of the ROI for the central frequency (dB/cm).
        """
    ...
    def computeBackscatterCoefficient(self, rfData: np.ndarray, refRfData: np.ndarray,
        ...
        convertedAttCoef = self.attenuationCoef * npConversionFactor / 100 # dB/cm -> Np/m
        convertedRefAttCoef = self.refAttenuation * npConversionFactor / 100 # dB/cm -> Np/m
