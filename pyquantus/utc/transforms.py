...
class ShortTimeFourierTransform:
    """Class for computing the Short-time Fourier transform for the ROI.
    """
    def __init__(self):
        pass
    
    def compute_stft_transformation(self):
        """Compute the Short-time Fourier transform for the ROI.
        """
        pass
...
class WaveletTransform:
    """Class for computing the Wavelet transform for the ROI.
    """
    def __init__(self):
        pass
    
    def compute_wavelet_transformation(self):
        """Compute the Wavelet transform for the ROI.
        """
        pass
...
class AttenuationCorrection:
    """Class for deattenuating the signal for the ROI.
    """
    def __init__(self):
        pass
    
    def do_attenuation_correction(self):
        """Deattenuate the signal for the ROI.
        """
        pass
...
class SignalDenoising:
    """Class for denoising the signal for the ROI.
    """
    def __init__(self):
        pass
    
    def do_signal_denoising_max_correlation(self):
        """Denoise the signal for the ROI using the max correlation method.
        """
        pass
